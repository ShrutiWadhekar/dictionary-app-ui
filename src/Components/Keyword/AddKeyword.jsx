...
class AddKeyword extends Component {
    ...
    saveKeyword = (c) => {
        ...
        } else if (keyword.inventor === "") {
            alert('the field inventor is mandatory!')
        } else if (keyword.inventionyear === "") {
            alert('the field invention year is mandatory!')
        } else if (!re.test(keyword.inventionyear)) {
            alert('Invention Year must be a number!')
        } else if (keyword.description === "") {
            alert('the field description is mandatory!')
        } else if (keyword.advantages === "") {
            alert('the field advantages is mandatory!')
        } else if (keyword.disadvantages === "") {
            alert('the field disadvantages is mandatory!')
        } else if (keyword.url1 === "" || keyword.url2 === "") {
            alert('URL1 and URL2 are mandatory fields (At least 2 image urls needed)')
        } else if (!keyword.url1.endsWith('jpg') && !keyword.url1.endsWith('png')) {
            alert("Please add image urls only with the extensions '.jpg' and '.png'")
        } else if (!keyword.url2.endsWith('jpg') && !keyword.url2.endsWith('png')) {
            alert("Please add image urls only with the extensions '.jpg' and '.png'")
        } else {

            if (keyword.url1 === "")
                keyword.url1 = "https://cdn.pixabay.com/photo/2017/07/10/23/43/question-mark-2492009__480.jpg"
            if (keyword.url2 === "")
                keyword.url2 = "https://cdn.pixabay.com/photo/2017/07/10/23/43/question-mark-2492009__480.jpg"
            if (keyword.url3 === "")
                keyword.url3 = "https://cdn.pixabay.com/photo/2017/07/10/23/43/question-mark-2492009__480.jpg"
            if (keyword.url4 === "")
                keyword.url4 = "https://cdn.pixabay.com/photo/2017/07/10/23/43/question-mark-2492009__480.jpg"
            if (keyword.url5 === "")
                keyword.url5 = "https://cdn.pixabay.com/photo/2017/07/10/23/43/question-mark-2492009__480.jpg"
            if (keyword.url6 === "")
                keyword.url6 = "https://cdn.pixabay.com/photo/2017/07/10/23/43/question-mark-2492009__480.jpg"

            console.log('keyword => ' + JSON.stringify(keyword));
            DictionaryService.addKeyword(keyword).then((res) => {
            ...
            <div className="containeradd">
                <div className="row">
                    <div className="card col-md-6 offset-md-3 offset-md-3">
                        <h2 className="text-center"><b>Add Keyword</b></h2><br />
                        <div className="card-body">
                            <form >
                                <table>
                                    <div className="form-group">
                                        <tr><td><label>Name: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label></td><td>
                                            <input placeholder="Enter Word" name="name" className="form-control" value={this.state.name} onChange={this.changeNameHandler} />
                                        </td></tr></div>
                                    <div className="form-group">
                                    ...
                                    <div> <p><b>Note: </b>If you do not provide all the image urls, default image will be added in place of those</p></div>
                                    <div>
                                        <tr><td><button className="btn btn-secondary" style={{ backgroundColor: "slategray" }} onClick={this.saveKeyword}>Submit Keyword</button><p>&nbsp; &nbsp; &nbsp;</p>
                                        </td> &nbsp; &nbsp;<td><button className="btn btn-secondary" style={{ backgroundColor: "slategray" }} onClick={this.list}>Back</button>
                                            </td></tr></div>
                                </table>
                            </form>
                        </div>
