...
class GiveAdminAccess extends Component {
    constructor(props) {
        super(props);
        this.state = {
            name: ''
    ...
    giveAccess = (c) => {
        ...
        AuthService.giveAdminAccess(this.state.name).then((res) => {
            console.log(res)
            alert(res.data)
        });
    }
            ...
            <div className="container">
                <div className="row" >
                    <div className="card col-md-6 offset-md-3 offset-md-3" style={{ position: "absolute", top: "150px" }}>
                        <h3 className="text-center"><b>Grant Admin Access</b></h3><br />
                        <div className="card-body">
                            <form>
                                <table>
                                    ...
                                    <div>
                                        <button className="btn btn-secondary" style={{ backgroundColor: "slategray" }} onClick={this.giveAccess}>Give Admin Access</button>
                                        &nbsp;
